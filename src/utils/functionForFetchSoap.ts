...
//   console.log("5 soniya o'tib ketdi. Keyingi qadamlar...");
  ...
  if(!convertedData['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ct:PrCtGetStatisticTlvResp'][0]['ct:listStatistic'][0]) {
    ...
    const LastLoginTime:string  = await convertedData['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ct:PrCtGetStatisticTlvResp'][0]['ct:listStatistic'][0]['ct:TmCtStatisticTlv'][0]['ct:listValue'][0]['ct:TmStatDataValueTlv'][11]['ct:strValue'][0]
    const FulDuration : string =await convertedData['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ct:PrCtGetStatisticTlvResp'][0]['ct:listStatistic'][0]['ct:TmCtStatisticTlv'][0]['ct:listValue'][0]['ct:TmStatDataValueTlv'][12]['ct:strValue'][0]
    const PauseDuration :string = await convertedData['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ct:PrCtGetStatisticTlvResp'][0]['ct:listStatistic'][0]['ct:TmCtStatisticTlv'][0]['ct:listValue'][0]['ct:TmStatDataValueTlv'][17]['ct:strValue'][0]
